 ...
 * the GameLocation, GameExit, GameItem, or GamePawn interfaces. This interface is used for any GameObject
 * components that will have a manageable inventory of items, and includes all of the functionality
 * for handling GameItem objects.
 */
    ...
    extends Serializable
{
     ...
     */
    public abstract boolean removeItemQuantity( GameItem item, int quantity );
     ...
     */
    public abstract void setItemUtility( GameContainerItemUtility newItemUtility );
