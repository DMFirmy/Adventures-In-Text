    ...
    extends BaseMap
{
    ...
    public void buildMapLocations()
    {
        ...
        room1.addExit( Engine.getComponentUtility().getDirection( "east" ), room1 );
        room1.addExit( Engine.getComponentUtility().getDirection( "west" ), room1 );
        room1.addExit( Engine.getComponentUtility().getDirection( "northeast" ), room1 );
        room1.addExit( Engine.getComponentUtility().getDirection( "southwest" ), room1 );
        room1.addExit( Engine.getComponentUtility().getDirection( "down" ), room1 );
        room1.addExit( Engine.getComponentUtility().getDirection( "up" ), room2 );

        // This room will require traveling "up" to reach which will require the custom "Fly" command.
        room2.addExit( Engine.getComponentUtility().getDirection( "down" ), room1 );
    ...
    public void buildMapMechanics()
    {
        ...
        exitAllowed.addEventCondition( new PawnInLocation( "playerInRoom1", Engine.getCurrentPlayer(),
                                                           ( GameLocation ) Engine.getComponentUtility().getComponent( "Room1" ) ) );
        exitAllowed.addEventCondition( new ContainerHasItems( "playerHasOrb", Engine.getCurrentPlayer(),
                                                              ( GameItem ) Engine.getComponentUtility().getComponent( "Orb" ), 1 ) );
    }
}
