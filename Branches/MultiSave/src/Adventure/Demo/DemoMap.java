    ...
    extends BaseMap
{
    ...
    public void buildMapMechanics()
    {
        ...
        narratorIntroducesSelf.addEventCondition( new DialogHasRun( "introComplete",
                                                                       ( GameDialog ) Engine.getComponent( "N-Intro" ), true ) );
        ...
        newWestWingDesc.addEventCondition( new HideableIsHidden( "hiddenRoomFound",
                                                                        ( GameHideable ) Engine.getComponent( "n_30" ), true ) );

        // We also check that this event only happens 1 time
        newWestWingDesc.addEventCondition( new ComponentHasStatus( "WWDescUpdated",
        ...
        LocationHasExitDirection exitPathNotAdded =
            new LocationHasExitDirection( "exitPathNotAdded", ( GameLocation ) Engine.getComponent( "Exit Corridor" ),
                                              Engine.direction( "South" ), true );
        ...
        LocationHasExitDirection exitPathAdded =
            new LocationHasExitDirection( "exitPathAdded", ( GameLocation ) Engine.getComponent( "Exit Corridor" ),
